...
DBM_SOULS_DESCRIPTION				= "Anuncia Enrage, Fixate, Souldrain, Rune Shield, Deaden and Spite."--translate
DBM_SOULS_OPTION_DRAIN				= "Announce Souldrain"--translate
DBM_SOULS_OPTION_DRAIN_CAST			= "Announce Souldrain cast (useful for Mass Dispel)"--translate
DBM_SOULS_OPTION_FIXATE				= "Announce Fixate"--translate
DBM_SOULS_OPTION_SPITE				= "Announce Spite"--translate
DBM_SOULS_OPTION_SCREAM				= "Announce Soul Scream"--translate
DBM_SOULS_OPTION_SPECWARN_SPITE		= "Show special warning when you are afflicted by Spite"--translate
DBM_SOULS_OPTION_WHISPER_SPITE		= "Send whisper to Spite targets"--translate
...
DBM_SOULS_DEBUFF_SPITE				= "([^%s]+) (%w+) afflicted by Spite%."--translate
DBM_SOULS_DEBUFF_SOULDRAIN			= "([^%s]+) (%w+) afflicted by Soul Drain%."--translate
DBM_SOULS_DEBUFF_FIXATE				= "([^%s]+) (%w+) afflicted by Fixate%."--translate
DBM_SOULS_YELL_ANGER_INC			= "¡Cuidado: estoy vivo!"

DBM_SOULS_WARN_ENRAGE_SOON			= "*** Enrage soon ***"--translate
DBM_SOULS_WARN_ENRAGE				= "*** Enrage ***"--translate
DBM_SOULS_WARN_ENRAGE_OVER			= "*** Enrage over ***"--translate
DBM_SOULS_WARN_RUNESHIELD			= "*** Rune Shield ***"--translate
DBM_SOULS_WARN_RUNESHIELD_SOON		= "*** Rune Shield in 3 sec ***"--translate
DBM_SOULS_WARN_DEADEN				= "*** Deaden ****"--translate
DBM_SOULS_WARN_DEADEN_SOON			= "*** Deaden in 5 sec ***"--translate
DBM_SOULS_WARN_DESIRE_INC			= "*** Essence of Desire - Zero mana in ~3 minutes ***"--translate
DBM_SOULS_WARN_MANADRAIN			= "*** Zero mana in 20 sec ***"--translate
DBM_SOULS_WARN_SPITE				= "*** Spite on %s ***"--translate
DBM_SOULS_WARN_SOULDRAIN			= "*** Souldrain on %s ***"--translate
DBM_SOULS_WARN_SOULDRAIN_CAST		= "*** Souldrain is casting ***"--translate
DBM_SOULS_WARN_FIXATE				= "*** Fixate: >%s< ***"--translate
DBM_SOULS_SPECWARN_FIXATE			= "Fixate!"--translate
DBM_SOULS_WARN_SCREAM				= "*** Soul Scream ***"--translate
DBM_SOULS_SPECWARN_SPITE			= "Spite!"--translate
DBM_SOULS_WARN_ANGER_INC			= "*** Essence of Anger ***";--translate
DBM_SOULS_WHISPER_SPITE				= "Spite on you!"--translate

-- Mother Shahraz
DBM_SHAHRAZ_NAME					= "Madre Shahraz"
DBM_SHAHRAZ_DESCRIPTION				= "Announces Fatal Attraction, sets an icons and sends whispers. Announces and shows a timer for Beams."--translate
DBM_SHAHRAZ_OPTION_BEAM				= "Announce Beams"--translate
DBM_SHAHRAZ_OPTION_BEAM_SOON		= "Show \"Beam soon\" warning"--translate

DBM_SHAHRAZ_YELL_PULL				= "Y bien... ¿negocios o placer?"

DBM_SHAHRAZ_WARN_ENRAGE				= "*** Enrage in %s %s ***"--translate
DBM_SHAHRAZ_WARN_FA					= "*** Fatal Attraction on %s ***"--translate
DBM_SHAHRAZ_SPECWARN_FA				= "Fatal Attraction"--translate
DBM_SHAHRAZ_WHISPER_FA				= "Fatal Attraction on you!"--translate
DBM_SHAHRAZ_WARN_BEAM_VILE			= "*** Vile Beam ***"--translate
DBM_SHAHRAZ_WARN_BEAM_SINISTER		= "*** Sinister Beam ***"--translate
DBM_SHAHRAZ_WARN_BEAM_SINFUL		= "*** Sinful Beam ***"--translate
DBM_SHAHRAZ_WARN_BEAM_WICKED		= "*** Wicked Beam ***"--translate
DBM_SHAHRAZ_WARN_BEAM_SOON			= "*** Beam in 3 sec ***"--translate

-- Illidari Council
DBM_COUNCIL_NAME					= "El Consejo Illidari"
DBM_COUNCIL_DESCRIPTION				= "Announces Circle of Healing, Deadly Poison, Divine Wrath, Vanish and shields."--translate
DBM_COUNCIL_OPTION_COH				= "Announce Circle of Healing"--translate
DBM_COUNCIL_OPTION_DP				= "Announce Deadly Poison"--translate
DBM_COUNCIL_OPTION_DW				= "Announce Divine Wrath"--translate
DBM_COUNCIL_OPTION_VANISH			= "Announce Vanish"--translate
DBM_COUNCIL_OPTION_VANISHFADED		= "Show warning when Vanish fades"--translate
DBM_COUNCIL_OPTION_VANISHFADESOON	= "Show warning 5 seconds before Vanish fades"--translate
DBM_COUNCIL_OPTION_SN				= "Announce Reflective Shield"--translate
DBM_COUNCIL_OPTION_SS				= "Announce Spell Shield"--translate
DBM_COUNCIL_OPTION_SM				= "Announce Melee Shield"--translate
DBM_COUNCIL_OPTION_DEVAURA			= "Announce Devotion Aura"--translate
DBM_COUNCIL_OPTION_RESAURA			= "Announce Resistance Aura"--translate
...
DBM_COUNCIL_WARN_CAST_COH			= "Circle of Healing"--translate
DBM_COUNCIL_WARN_POISON				= "Deadly Poison on >%s<"--translate
DBM_COUNCIL_WARN_SHIELD_NORMAL		= "Reflective Shield"--translate
DBM_COUNCIL_WARN_SHIELD_SPELL		= "Spell Shield on %s"--translate
DBM_COUNCIL_WARN_SHIELD_MELEE		= "Melee Shield on %s"--translate
DBM_COUNCIL_WARN_VANISH				= "Vanish"--translate
DBM_COUNCIL_WARN_VANISH_FADED		= "Vanished faded"--translate
DBM_COUNCIL_WARN_WRATH				= "Divine Wrath on >%s<"--translate
DBM_COUNCIL_WARN_AURA_DEV			= "Devotion Aura"--translate
DBM_COUNCIL_WARN_AURA_RES			= "Resistance Aura"--translate
DBM_COUNCIL_WARN_VANISHFADE_SOON	= "Vanish fades in 5 sec"--translate
