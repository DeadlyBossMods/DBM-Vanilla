...
function mod:CHAT_MSG_MONSTER_YELL(msg)
	...
	elseif msg == L.Wave2 then
		self:SendSync("Wave", 2)
	elseif msg == L.Wave3 then
		self:SendSync("Wave", 3)
	elseif msg == L.Wave4 then
		self:SendSync("Wave", 4)
	elseif msg == L.Wave5 then
		self:SendSync("Wave", 5)
	elseif msg == L.Wave6 then
		self:SendSync("Wave", 6)
	elseif msg == L.Wave7 then
		self:SendSync("Wave", 7)
	elseif msg == L.Wave8 then
