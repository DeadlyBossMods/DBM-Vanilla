local mod	= DBM:NewMod("AvatarofHakkarSoD", "DBM-Raids-Vanilla", 9)
local L		= mod:GetLocalizedStrings()

mod:SetRevision("@file-date-integer@")
mod:SetCreatureID(221394)--or 221761
...
--]]
--https://www.wowhead.com/classic/spell=444253/corrupted-blood
--https://www.wowhead.com/classic/spell=444039/insanity
