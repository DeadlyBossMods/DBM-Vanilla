...
local timerNextPlatform	= mod:NewTimer(35, "NextPlatform")--This needs an actual spell trigger since i cant make heads or tails of how original mod worked without using any tigger.
