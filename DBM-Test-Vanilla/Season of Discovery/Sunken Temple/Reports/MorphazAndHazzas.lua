...
Findings:
	Timer for spell ID 445235 (Lucid Dreaming) is triggered by event SPELL_CAST_START 449422 (Lucid Dreaming)

Unused objects:
	None

Timers:
	Lucid Dreaming, time=20.00, type=cast, spellId=445235
	...
	Eternal Slumber, time=30.00, type=cast, spellId=446144
...
Announces:
	Dreamer's Lament (%s), type=count, spellId=446468
	...
	Animate Flame, type=spell, spellId=446661
...
Special warnings:
	Backfire! (%s), type=count, spellId=446489
